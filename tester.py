...
import psycopg2
import sys
import parallel_sort_join as parallel_sort_join

DATABASE_NAME = 'parallel_sort_join'

def getOpenConnection(user='postgres', password='1234', dbname='parallel_sort_join'):
    return psycopg2.connect("dbname='" + dbname + "' user='" + user + "' host='localhost' password='" + password + "'")

def createDB(dbname='parallel_sort_join'):
    """
...
if __name__ == '__main__':
    try:
        ...
        parallel_sort_join.ParallelSort('ratings', 'Rating', 'parallelSortOutputTable', con);
        ...
        parallel_sort_join.ParallelJoin('ratings', 'movies', 'MovieId', 'MovieId1', 'parallelJoinOutputTable', con);
        a = raw_input("Check in database and once you are done, press enter to delete all tables: ");
        deleteTables('ALL', con);
